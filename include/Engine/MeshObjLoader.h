...
struct SMaterial {
	CCString		materialName[255];			//The Material Name
	CCString		textureFileName[255];		//The texture file name, if this is a texture map
...
struct S3DObject {
	...
	CCString	objectName;					//The name of the Object
